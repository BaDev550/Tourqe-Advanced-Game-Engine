...
namespace TAGE::Renderer
{
	...
	public:
		...
		void AddMesh(MEM::Scope<Mesh> mesh) { _meshes.push_back(std::move(mesh)); }
	private:
		...
		void LoadTextureToMaterial(TextureType type, aiMaterial* material, MEM::Ref<Material>& outMaterial);
