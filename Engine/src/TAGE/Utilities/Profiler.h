...
#define PROFILE_BEGIN_SESSION(name, filepath) ::TAGE::Instrumentor::Get().BeginSession(name, filepath)
#define PROFILE_END_SESSION() ::TAGE::Instrumentor::Get().EndSession()
#define PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::TAGE::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
											   ::TAGE::InstrumentationTimer timer##line(fixedName##line.Data)
