...
namespace TARE {
	Vulkan_RenderContext::Vulkan_RenderContext(GLFWwindow* handle)
		: _Window(handle)
	{
	}
	...
	void Vulkan_RenderContext::SwapBuffers()
	{
	}

	void Vulkan_RenderContext::createVKInstance()
	{
	...
	void Vulkan_RenderContext::createVKLogicalDevice()
	{
	...
	void Vulkan_RenderContext::createVKSurface()
	{
	...
	bool Vulkan_RenderContext::checkInstanceExtensionSupport(std::vector<const char*>* checkExtensions)
	{
	...
	bool Vulkan_RenderContext::checkDeviceSuitable(VkPhysicalDevice device)
	{
	...
	void Vulkan_RenderContext::getPhysicalDevice()
	{
		uint deviceCount = 0;
	...
	Utilities::QueueFamilyIndices Vulkan_RenderContext::getQueueFamilies(VkPhysicalDevice device)
	{
	...
	void Vulkan_RenderContext::PrintDeviceProperties(VkPhysicalDeviceProperties device)
	{
